-- P&C Insurance Benchmark schema subset
-- Source: "Knowledge Graph and LLM Accuracy Benchmark Report", Appendix 9.1
-- Based on: OMG Property & Casualty Data Model (dtc/13-04-15)
-- 13 tables, 65 columns total
-- DO NOT MODIFY without updating the expected counts in parse_ddl_to_config.py
